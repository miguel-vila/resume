...
\address{Carrera 96 d bis \# 22g-29 \\ Bogot\'a, Colombia} % Your address
\address{
%	(+571)~$\cdot$~695~$\cdot$~4631 \\ 
	Tel\'efono m\'ovil: 310$\cdot$751$\cdot$4361 \\
...
\item Implementaci\'on de procesos de negocio y de mediaciones de servicios web.
\end{rSubsection}

%------------------------------------------------

\begin{rSubsection}{CIACUA, Universidad De Los Andes}{Marzo de 2011 - Agosto de 2011}{Ingeniero de Software}{Bogot\'a, Colombia}
...
\begin{tabular}{ @{} >{\bfseries}l @{\hspace{6ex}} l }
Lenguajes de programaci\'on & \\ \textbf{(en orden de destreza):}& Java, Python, Ruby. \\%, Javascript, Octave, Matlab\\
Certificaciones: & Certified Scrum Developer. Familiarizado con BDD y TDD. \\
Desarrollo web:& Dominio medio de JSF, CSS y Javascript.\\
%Desarrollo m\'ovil: & Android y Windows Phone\\
Plataformas: & Java EE 6.\\%, familiarizado con Ruby On Rails.\\

...
{\bf \recurse_center} \hfill August 2016 - November 2016 \\
...
\item Implemented a business process, a BPEL microflow and multiple web services mediations.
\item Took part in the development of a system that orchestrated the consumption of multiple web services using Scala.
%\item Took part in the development of a REST API and a Single Page Application using the Play framework (using Scala) and using the Ember.js framework.
\item Took part in the development of an application for the insurance sector using Scala and Angular.js.
\end{rSubsection}
...
I was in charge of evaluating homeworks and exams and also giving tutorials.
\end{rSubsection}
